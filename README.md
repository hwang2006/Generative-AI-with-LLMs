...
Here is a **QuickStart guide** to get *Generative AI with LLMs* exercises kicked off on Neuron, even with no need to create the conda virtual environment, by leveraging the Singularity *genai* container image located in the /apps/applications/singularity_images/ngc directory.
