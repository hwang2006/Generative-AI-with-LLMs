...
If you have an account on Neuron, here is a QuickStart guide to get *Generative AI with LLMs* practices on a supercomputer started, even with no creation of the conda virtual environment required, by leveraging the Singularity *genai* container image located in the /apps/applications/singularity_images/ngc directory.
