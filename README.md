...
the the lab exercised files through the Jupyter Notebook interface that you have launced. You could start with **Lab_1_summarize_dialogue.ipynb** by just clickihng it that covers dialogue summarization exercises with prompt engineering.  
